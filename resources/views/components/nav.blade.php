<nav x-data="{ showNav: false }" @keydown.escape="showNav = false" class="bg-gray-800">
    ...
    <div class="flex items-center justify-between h-16">
      ...
      <div class="hidden md:block">
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <div @click="showNav = false" class="ml-3 relative">
            <div>
      ...
      <div class="-mr-2 flex md:hidden">
        <button @click="showNav = !showNav"
          ...
          <svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
            <path :class="{'hidden': showNav, 'inline-flex': !showNav }" class="inline-flex" stroke-linecap="round"
              stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
            <path :class="{'hidden': !showNav, 'inline-flex': showNav }" class="hidden" stroke-linecap="round"
  ...
  <div :class="{'block': showNav, 'hidden': !showNav}" class="hidden md:hidden">
