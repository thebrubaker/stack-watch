<template>
  <div id="application-shell">
    <nav class="bg-gray-800">
        ...
        <div class="flex items-center justify-between h-16">
          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              ...
              <div
                class="ml-3 relative"
                v-click-outside="() => (showUserNav = false)"
              >
                <div>
                  <button
                    @click="showUserNav = !showUserNav"
          ...
          <div class="-mr-2 flex md:hidden">
            ...
            >
              ...
              >
                <path
                  :class="{ hidden: showUserNav, 'inline-flex': !showUserNav }"
                  class="inline-flex"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  stroke-width="2"
      ...
      <div
        :class="{ block: showUserNav, hidden: !showUserNav }"
